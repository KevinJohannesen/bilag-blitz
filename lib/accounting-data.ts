...
export const ACCOUNTS: Account[] = [
  // Klasse 1 - Eiendeler
  {
    ...
    name: "Maskiner",
    category: "Eiendeler",
    description: "Varige driftsmidler",
  },
  {
    code: "1500",
    name: "Kundefordringer",
    category: "Eiendeler",
    description: "Fordringer",
  },
  {
    code: "1920",
    name: "Bankinnskudd",
    category: "Eiendeler",
    description: "Kontanter og bank",
  },
  {
    code: "1930",
    name: "Kontanter",
    category: "Eiendeler",
    description: "Kassebeholdning",
  },
  ...
  // Klasse 2 - Gjeld og egenkapital
  {
    ...
    description: "Innskutt kapital",
  },
  {
    code: "2400",
    name: "Leverandørgjeld",
    category: "Gjeld",
    description: "Kortsiktig gjeld",
  },
  {
    code: "2710",
    name: "Utgående MVA",
  ...
  // Klasse 3 - Inntekter
  {
    ...
    name: "Salgsinntekter",
    category: "Inntekter",
    description: "Omsetning",
  },
  {
    code: "3100",
    name: "Tjenestesalg",
    category: "Inntekter",
    description: "Salg av tjenester",
  },
  ...
  // Klasse 4 - Varekostnad
  {
    ...
    name: "Varekostnad",
    category: "Kostnad",
    description: "Innkjøp varer",
  },
  {
    code: "4300",
    name: "Innkjøp varer",
    category: "Kostnad",
    description: "Vareforbruk",
  },
  ...
  // Klasse 5 - Lønnskostnader
  {
    ...
    name: "Lønn",
    category: "Kostnad",
    description: "Lønnskostnader",
  },
  {
    code: "5400",
    name: "Arbeidsgiveravgift",
    category: "Kostnad",
    description: "Sosiale kostnader",
  },
...
export interface TransactionTemplate {
  description: string;
  correctDebitAccount: string;
  correctCreditAccount: string;
...
export const TRANSACTION_TEMPLATES: TransactionTemplate[] = [
  // Bank transactions
  {
    ...
    correctDebitAccount: "1920",
    correctCreditAccount: "1500",
    amount: { min: 5000, max: 150000 },
    keywords: ["betaling", "innbetaling", "overføring"],
  },
  {
    description: "Utbetaling til leverandør",
    correctDebitAccount: "2400",
    correctCreditAccount: "1920",
    amount: { min: 2000, max: 80000 },
    keywords: ["betaling", "utbetaling"],
  },
  {
    description: "Kontantuttak fra bank",
    correctDebitAccount: "1930",
    correctCreditAccount: "1920",
    amount: { min: 1000, max: 10000 },
    keywords: ["kontant", "uttak"],
  },

  // Customer/Supplier
  {
    description: "Faktura sendt til kunde",
    correctDebitAccount: "1500",
    correctCreditAccount: "3000",
    amount: { min: 10000, max: 500000 },
    keywords: ["faktura", "kunde"],
  },
  {
    description: "Faktura mottatt fra leverandør",
    correctDebitAccount: "4000",
    correctCreditAccount: "2400",
    amount: { min: 5000, max: 200000 },
    keywords: ["faktura", "leverandør"],
  },

  // VAT
  {
    description: "Beregnet utgående MVA",
    correctDebitAccount: "1500",
    correctCreditAccount: "2710",
    amount: { min: 2500, max: 125000 },
    keywords: ["mva", "utgående"],
  },
  {
    description: "Fradragsberettiget MVA",
    correctDebitAccount: "2711",
    correctCreditAccount: "2400",
  ...
  {
    description: "Konsulenthonorar mottatt",
    correctDebitAccount: "1920",
    correctCreditAccount: "3100",
    amount: { min: 15000, max: 200000 },
    keywords: ["tjeneste", "honorar", "konsulent"],
  },
  ...
  // Cost of goods
  {
    ...
    keywords: ["innkjøp", "varer", "lager"],
  },
  {
    description: "Varekjøp",
    correctDebitAccount: "4300",
    correctCreditAccount: "1920",
  ...
  // Salaries
  {
    ...
    correctDebitAccount: "5000",
    correctCreditAccount: "1920",
    amount: { min: 30000, max: 80000 },
    keywords: ["lønn", "utbetaling"],
  },
  {
    description: "Arbeidsgiveravgift",
    correctDebitAccount: "5400",
    correctCreditAccount: "1920",
    amount: { min: 4000, max: 15000 },
    keywords: ["avgift", "arbeidsgiver"],
  },

  // Operating expenses
  {
    description: "Betaling av husleie",
    correctDebitAccount: "6300",
    correctCreditAccount: "1920",
    amount: { min: 8000, max: 50000 },
    keywords: ["leie", "lokale", "husleie"],
  },
  {
    description: "Kjøp av kontormøbler",
    correctDebitAccount: "6540",
    correctCreditAccount: "1920",
    amount: { min: 3000, max: 30000 },
    keywords: ["inventar", "møbler", "kontor"],
  },
  {
    description: "Kontorrekvisita",
    correctDebitAccount: "6800",
    correctCreditAccount: "1920",
  ...
  // Other costs
  {
    description: "Drivstoffutgifter",
    correctDebitAccount: "7100",
    correctCreditAccount: "1920",
    amount: { min: 500, max: 3000 },
    keywords: ["bil", "drivstoff", "bensin"],
  },
  {
    description: "Flybilletter forretningsreise",
    correctDebitAccount: "7350",
    correctCreditAccount: "1920",
  ...
  // Assets
  {
    ...
    correctDebitAccount: "1200",
    correctCreditAccount: "2400",
    amount: { min: 50000, max: 500000 },
    keywords: ["maskin", "utstyr", "produksjon"],
  },
  {
    description: "Avskrivning på maskiner",
    correctDebitAccount: "6000",
    correctCreditAccount: "1200",
    amount: { min: 5000, max: 50000 },
    keywords: ["avskrivning", "verdifall"],
  },
];
...
export function generateTransaction(): Transaction {
  ...
  const debitAccount = ACCOUNTS.find(
    (a) => a.code === template.correctDebitAccount,
  )!;
  const creditAccount = ACCOUNTS.find(
    (a) => a.code === template.correctCreditAccount,
  )!;
  const amount = Math.floor(
    Math.random() * (template.amount.max - template.amount.min) +
      template.amount.min,
  );
  ...
  return {
    ...
    amount,
    correctDebitAccount: template.correctDebitAccount,
    correctCreditAccount: template.correctCreditAccount,
...
export type GameMode = "enkeltsidet" | "dobbeltsidet";
